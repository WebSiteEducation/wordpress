...
jQuery(document).ready(function() {
	...
	// masonry For Item Post
	/*s$.Isotope.prototype._getCenteredMasonryColumns = function() {
...
var $container = $('#fullwidth');
	...
	//infinitescroll Next Post
	/*$container.infinitescroll({
		navSelector : '#pagenavi_birva', // selector for the paged navigation
		nextSelector : '#pagenavi_birva a', // selector for the NEXT link (to page 2)
		itemSelector : '.postlist', // selector for all items you'll retrieve
		loading: {
