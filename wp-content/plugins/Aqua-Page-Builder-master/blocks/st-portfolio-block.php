...
class ST_Portfolio_Block extends AQ_Block {
   ...
   function block($instance){
    ...
    $html.=	'<div id="project'.$i.'">
			...
			$html.='<div class="col-sm-6 col-sm-offset-3">';
				...
				if ($format == ( 'video' ) || $format == ( 'audio' ) ) {
					$html.='<div class="text-center">'.strip_shortcodes(get_the_content()).'</div>';
					...
					$html.='<div class="text-center">';
						$html.='<div class="lead">'.strip_shortcodes(get_the_content()).'</div>';
						$html.='<p><a class="btn btn-primary btn-lg" href="'.$project.'">Learn More</a></p>';
					$html.='</div>';	
				...
				$html.='<div class="container">
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<a href="'.$project.'" class="btn btn-primary btn-lg">View Project</a>
						</div>
					</div>
				</div>';
	...
	if($show_button == 1){
		$html.='<div id="contactform1" class="viewall_portfolio">';
