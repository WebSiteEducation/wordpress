...
class ST_Banner_Block extends AQ_Block {
   ...
   function form($instance){
	...
	<div class="description">
		<label for="<?php echo $this->get_field_id('logo_hook') ?>">
			pick a color for logo hook
			<?php echo aq_field_color_picker('logo_hook', $block_id, $logo_hook, $default = '') ?>
		</label>
	</div>
	<div class="cf"></div>
